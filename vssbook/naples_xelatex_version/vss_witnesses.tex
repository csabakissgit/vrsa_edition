...
\skt{vaktum arhasi}. In some instances, the paper
...
is not frequently seen. Two instances of such a 
 \cskt{kākapada}{kakapada} in in that book
...
one in the above mentioned MS NGMPP C 57/5 from 1826 \CE,%
		\footnote{MS NGMPP C57/5, 
							\mycitep{EinickeKorrektur}{164 and 328}.} 
...
start with \skt{karmahetuḥ śarīrasya}
...
of the Śivadharma corpus (\mycite{NaraharinathSivadharma}).%
			\footnote{See, e.g.,
...
Naraharinath's edition is that its quality is
considerably inferior to those of the other texts of the corpus.
It may or may not be Naraharinath's fault; 
others must have been involved in the process of transcription, and the number and nature of the innumerable mistakes all over the text may also suggest a general problem with the typesetting process. In addition to this, it is clearer and clearer that
...
from them. See the description of \msPaperA\ and
\msPaperC\ above.
...
Therefor I have recorded the readings found in his
