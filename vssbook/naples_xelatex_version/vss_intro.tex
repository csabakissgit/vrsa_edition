...
according to \mycitep{PrakritProperNames2}{850}.%
	\footnote{The references given are the Jaina 
			\textsl{Jambūdvīpaprajñapti} and \textsl{Sthānāṅga\-sūtra}.} 
...
\noindent            
The translation of this verse, suprising as it may seem, is, based on the
...
his analysis of the language of the \SvayP\ (\mycite{KolverErgative}),
...
Constructions with \skt{datta}/\skt{kathita} plus dative 
...
past participle plus \skt{asmi, asi, asti}
...
\textsl{Vicitra\-karṇikāvadā\-noddhṛta}, namely that
...
\subsubsection{Cardinal and ordinal numbers}
...
\begin{quote}
 1.64a: \skt{vāyunā pāda saṃkṣipya} (\skt{pādaṃ}) \\
1.64c: \skt{tenāpi pāda saṃkṣipya} (\skt{pādaṃ}) \\
...
\skt{śy, śv, sv, dv},%
	\footnote{See, e.g., the end of 5.15b: \skt{śukaśyenakān} for \ \shortsyllable\ 
...
is not turned into long, are encircled.
...
8.33a: \skt{tasmān mauna\Circled{vr}ataṃ sadaiva sudṛḍhaṃ kurvīta yo niścitaṃ} 
 (\skt{śārdūlavikrīḍita})\\
10.31b: \skt{īśānenābhijuṣṭaṃ hṛdi \Circled{hr}ada vimalaṃ nādaśītāmbupūrṇam} (\skt{sragdharā})\\
...
regularly, and exclusively in non-\skt{anuṣṭubh} verses,
in the \VSS\ is that a word-final short syllable can count 
...
5.20a: \skt{śaucāśaucavidhijña mānava ya\Circled{di} kālakṣaye niścayaḥ} (\skt{śā\-rdū\-la\-vikrīḍita})\\
...
12.150c: \skt{nityaṃ rogādhivā\Circled{sa}m aniyatavapuṣaṃ trāhi māṃ kālapāśāt} (\skt{sragdharā})
\end{quote} 
