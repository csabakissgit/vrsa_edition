...
\phantomsection\section{Śivadharma corpus}
...
so-called \Sivadharmacorpus.%
                        \index{Vrsasarasamgraha@\titleface{V{\dharmar}ṣasārasa{\dharmanusvara}graha}!in the Śivadharma corpus}
We have no evidence that it was ever transmitted independently of this collection of texts,%
...
In addition, there is no sign of the \VSS's transmission outside \enx{Nepal}.
...
Since the \VSS's%
                \index{Vrsasarasamgraha@\titleface{V{\dharmar}ṣasārasa{\dharmanusvara}graha}!in the Śivadharma corpus}
links to other texts of the corpus---except possibly the 
\DharmP---are relatively weak, I will refer to the \Sivadharmacorpus\ and
...
\phantomsection\section{Title}\label{title}
The title \Vss%
	\footnote{Read \Vss\ for \titleface{V{\dharmar}ttasārasaṅgraha}
	in \mycitep{PetechHistory}{84}.}
can be translated as `Compendium on the Essence of the Bull\index{bull} [of Dharma].'
The last two elements (\skt{sāra-sa{\dharmanusvara}graha}) need
little explanation: this work is a `compendium,' a `collection' (\skt{sa{\dharmanusvara}graha})
...
The\label{bull} remaining question is whether the bull\index{bull} in the title 
...
sometimes called Nandi or Nandin in other works.%
                \footnote{There is no trace of \enx{Nandi}/Nandin
		as identified with the bull in the \Vss.
		On the possible time after which 
                \enx{Nandi} or Nandin, originally a \cskt{gaṇa}{gana},
		was considered a \enx{bull}, see 
		\mycite{bhattacharya_nandin_1977} and 
		\mycitep{Pancavaranastava}{100--108 and 171--172}.}

Dharma is frequently referred to as a \enx{bull},\myidxsub{bull}{of Dharma} 
often depicted as losing a leg in every Kalpa.\mysktidx{kalpa}
This portrayal appears in Dharma literature from at least the time of the \MBh;
see, e.g., \MBH\ 3.188.10--12,%
	\footnote{\MBH\ 3.188.10--12: \skt{k{\dharmar}te catuṣpāt sakalo nirvyājopādhivarjitaḥ |      \\
                                  v{\dharmar}ṣaḥ pratiṣṭhito dharmo manuṣyeṣv abhavat purā || \\
				  adharmapādaviddhas tu tribhir a{\dharmanusvara}śaiḥ pratiṣṭhitaḥ |\\
				  tretāyā{\dharmanusvara} dvāpare 'rdhena vyāmiśro dharma ucyate || \\
				  tribhir a{\dharmanusvara}śair adharmas tu lokān ākramya tiṣṭhati |\\
   				  caturthā{\dharmanusvara}śena dharmas tu manuṣyān upatiṣṭhati ||.}}
and \Manu\ 1.81a
(\skt{catuṣpāt sakalo dharmaḥ}) and 8.16a
(\skt{v{\dharmar}ṣo hi bhagavān dharma}).%
...
In addition, in Śaiva contexts, the bull of Dharma\myidxsub{bull}{of Dharma}
does feature as \enx{Śiva}'s vehicle. See, e.g., Bakker's\myidx{Bakker, Hans} argument, who,
...
original \titleface{Skandapurāṇa}[; \dots]\myidx{Skandapurāṇa}
the uncontrollable, wild bull \ie{v{\dharmar}ṣa}%
                        \mysktidx{v{\dharmar}ṣa}
is domesticated by \enx{Śiva}'s Gaṇapa \enx{Prabhākara} [\dots]
In this way the \enx{bull} is transformed into \enx{Śiva}'s vehicle \ie{vāhana}\mysktidx{vāhana}.
\end{quote}
...
\begin{quote}
Making the \enx{bull} \enx{Śiva}'s vehicle implies that \enx{Śiva} has become
...
been accommodated in [Ś]aivism.%
	...
	\citeauthor{bhattacharya_nandin_1977} 		
		...
		(\csindexxx{V{\dharmar}ṣabha}{vrsabha}{\skt{v{\dharmar}ṣabha}} or
		\csindexxx{V{\dharmar}ṣa}{vrsa}{\skt{v{\dharmar}ṣa}})
	of \enx{Śiva} is identified with Dharma, ``virtue personified''. 
...
\noindent
The possibility that the \enx{bull} in the title \Vss\ refers 
not only to Dharma as a \enx{bull}, but also
to \enx{Śiva}'s \skt{vāhana}\myidx{vāhana} has been mentioned
in \mycite{UmaSivaPlay},%
        \footnote{P. 238 n.~13.}
...
\begin{quote} 
while the \enx{bull} as a synonym of Dharma is mentioned in the text repeatedly,
somewhat surprisingly, and perhaps significantly, there is no
clear reference to \enx{Śiva}'s mount in the \Vss. [\dots\ Nevertheless, it]
is not inconceivable that the redactors of the \Vss\ had
the same association in mind, namely that the \enx{bull} in 
question is both Dharma and \enx{Śiva}'s mount.%
	\footnote{Note that \SDhU\  12.87
				also mentions the `Dharma bull':
	    \skt{īśvarā\-yatanasyādhaḥ śrīmān dharmav{\dharmar}ṣaḥ sthitaḥ} |
    	\skt{yatra vīrav{\dharmar}ṣas tatra kṣityā{\dharmanusvara} gomātaraḥ sthitā} ||.
...
%13076027a v{\dharmar}ṣabha{\dharmanusvara} ca dadau tasmai saha tābhiḥ prajāpatiḥ
%13076027c prasādayām āsa manas tena rudrasya bhārata
%13076028a prītaś cāpi mahādevaś cakāra v{\dharmar}ṣabha{\dharmanusvara} tadā
%13076028c dhvaja{\dharmanusvara} ca vāhana{\dharmanusvara} caiva tasmāt sa v{\dharmar}ṣabhadhvajaḥ
%13076029a tato devair mahādevas tadā paśupatiḥ k{\dharmar}taḥ
%13076029c īśvaraḥ sa gavā{\dharmanusvara} madhye v{\dharmar}ṣāṅka iti cocyate
...
%the meaning `dharma' as first when defining the word `v{\dharmar}ṣa':
%
%\begin{quote}
%    \skt{dharmo v{\dharmar}ṣo v{\dharmar}ṣaḥ śreṣṭho v{\dharmar}ṣo gaur mūṣiko v{\dharmar}ṣaḥ} |\\
%    \skt{v{\dharmar}ṣo bala{\dharmanusvara} v{\dharmar}ṣaḥ kāmo v{\dharmar}ṣalo v{\dharmar}ṣa ucyate} || 1.48
%    \end{quote}

% Śivapurāṇa:
% śuddhasphaṭikasa{\dharmanusvara}kāśo v{\dharmar}ṣabhaḥ sarvasundaraḥ ||
% yo dharma ucyate vedaiḥ śāstraiḥ siddhamaharṣibhiḥ ||54||
% tam ārūḍho mahādevo v{\dharmar}ṣabha{\dharmanusvara} dharmavatsalaḥ||
% śuśubhe 'tīva devarṣisevitaḥ sakalair vrajan ||55||


%visnusmrḍn:ViS 86.15a/ v{\dharmar}ṣo hi bhagavān dharmaś catuṣ-pādaḥ prakīrtitaḥ
%/
%
%Śivapurāṇa 2.3.40.54--55:
%
%\begin{quote}
%\skt{śuddhasphaṭikasa{\dharmanusvara}kāśo v{\dharmar}ṣabhaḥ sarvasundaraḥ} |\\
%\skt{yo dharma ucyate vedaiḥ śāstraiḥ siddhamaharṣibhiḥ} ||\\
%\skt{tam ārūḍho mahādevo v{\dharmar}ṣabha{\dharmanusvara} dharmavatsalaḥ} |\\
%\skt{śuśubhe 'tīva devarṣisevitaḥ sakalair vrajan} ||
%\end{quote}
%also quoted by \mycitep{bhattacharya_nandin_1977}{1553}	

%smrti/dharma/krtyaratnaakara.dn: !!! dharmo 'ya{\dharmanusvara} v{\dharmar}ṣarūpeṇa nāmnā
%nandīśavaro vibhuḥ \textbar{} dharmān māheśvarān vakṣyaty ataḥ prabh{\dharmar}ti
%nārada\textbar{}\textbar{}
%
%tak2015/AtmapujaT55Muktabodha.dn: dharmas tatra v{\dharmar}ṣākāro jñānaḥ
%si{\dharmanusvara}hasvarūpakaḥ \textbar{} vairāgya{\dharmanusvara}
...
%(v{\dharmar}ṣa) is both a synonym of `religious practice' and the traditional
...
on the idea of \cskt{v{\dharmar}ṣa}{vrsa} being Dharma
in general, and on the \enx{bull} appearing on the coins of the 
Hephthalite Hun Mihirakula in particular, also referencing the \VSS: 

\begin{quote}
To laud the \enx{bull} (\cskt{v{\dharmar}ṣa}{vrsa})
would be surprising if the intended meaning were 
the \enx{bull} that is \enx{Śiva}'s mount, but not if the word is 
intended in its figurative meaning, namely \skt{dharmaḥ}, 
or \skt{su\-k{\dharmar}tam} `the virtuous actions [prescribed by
the Veda].' For this meaning of \skt{v{\dharmar}ṣaḥ} see, for example,
Amarasi{\dharmanusvara}ha, \skttitle{Nāmaliṅgā\-nuśāsana}{Namalinganusasana}
1.4.25b (\skt{suk{\dharmar}tam v{\dharmar}ṣaḥ}),
3.3.220 (\skt{su\-k{\dharmar}te v{\dharmar}ṣabhe v{\dharmar}ṣaḥ});
Halāyudha,
\skttitle{Abhidhānaratnamālā}{Abhidhanaratnamala}\linebreak
1.125cd (\skt{dharmaḥ puṇya{\dharmanusvara} v{\dharmar}ṣaḥ śreyaḥ
suk{\dharmar}ta{\dharmanusvara} ca sama{\dharmanusvara} sm{\dharmar}tam});
\Manu 8[.]16a (\skt{v{\dharmar}ṣo hi bhagavān dharmas}\dots);
and the Gwalior Museum Stone
Inscription of Pataṅgaśambhu (\mycite{MirashiGwalior1962}), l. 15,
\skt{v{\dharmar}ṣaikaniṣṭho `pi jitasmaro 'pi yaḥ śaṅkaro 'bhūd
bhuvi ko 'py apūrvvaḥ}, 
concerning the Śaiva ascetic Vyomaśambhu: 
`He was in the world an extraordinary new Śiva, since he too was 
\skt{v{\dharmar}ṣaikaniṣṭhaḥ}
...
urges'; in Śiva's case `the defeater of the Love god \enx{Kāmadeva}'). 
This is also the meaning of \skt{v{\dharmar}ṣaḥ} in the title \Vss,
...
may collectively call the \Sivadharma, and he
thus supplies `Śiva' when translating the title \Vss.
A closer examination of the \VSS\ 
reveals no direct references to either \enx{Śiva}'s \enx{bull} or
to the \enx{bull} embodying the \Sivadharma. Instead, the bull
in the \VSS\ is repeatedly associated with the Dharma which
is the four \asrama s (see, e.g., \VSS\ 3.1--5 and 4.74).
My conclusion here is that while the word \cskt{v{\dharmar}ṣa}{vrsa} in the
title may indeed refer to \enx{Śiva}'s \enx{bull}, 
this reference is always only implied and never explicitly stated,
whereas the \enx{bull} as the personification of Dharma as the four
\asrama s appears explicitly and repeatedly. Thus
the title lacks any explicit hint to \enx{Śaivism},%
	\footnote{In contrast, see an explicit equation of the bull
	of Dharma with \enx{Śiva}'s mount in the \Uums\
					(\msCa\ fol.~184r ll. 3--4; see
					\mycitep{KissVolume2021}{185--186}):
		\skt{īśvara uvāca |
  			na jānanti ca loke 'smin mānavā mūḍhacetasaḥ |
 			catuṣpādo bhaved dharmaḥ śuklo 'ya{\dharmanusvara} mama vāhanaḥ ||};
...
affiliation to \enx{Dharmaśāstra}, \enx{Vaiṣṇavism}, and \enx{Śaivism}.%
...
%\mysubsubsection{V{\dharmar}ṣadeva's commission?}{vrsadevas-commission}
Finally, as a fanciful experiment, and if one accepts 
that the \VSS\ originated in \enx{Nepal},%
		\footnote{See pp.~\pageref{provenance}ff.}
one could wonder whether the title \Vss\ 
has anything to do with the Licchavi\myidx{Licchavi kings} king V{\dharmar}ṣadeva.%
                \myidx{V{\dharmar}ṣadeva}
\citeauthor{SandersonSaivaAge} 
(\citeyear{SandersonSaivaAge}, 74) mentions that  
V{\dharmar}ṣadeva%
        \myidx{V{\dharmar}ṣadeva}
is `described in an inscription of his eighth-century
descendant \enx{Jayadeva} as having inclined towards \enx{Buddhism};%
...
`the Caitya of the \enx{Sīnagu-vihāra} (the \enx{Svayambhūnāth Caitya}).'
More importantly, Sanderson summarises the 
information found in the \enx{Chāṅgu Nārāyaṇa Pillar Inscription} (east shaft),%
                \footnote{See, e.g., \mycitep{GnoliNepInscr}{1}, \mycite{RiccardiChangu} and
                \url{https://siddham.network/inscription/in02001/}}
noting that V{\dharmar}ṣadeva was the great-grand\-father of \enx{Mānadeva}, whose
`dated inscriptions range in date from 459 to 505/6' [\CE].%
                \footnote{\mycitep{SandersonSaivaAge}{75}.}
%	   \footnote{V{\dharmar}ṣadeva was succeeded by Śaṅkaradeva and   		            Dharmadeva.}
This would place the reign of V{\dharmar}ṣadeva%
        \myidx{V{\dharmar}ṣadeva}
around 400 \CE.
...
If such a connection exists, it might explain the slightly unusual nature of the
title (`\dots\ the essence of the \enx{bull}').
\hide{
...
%
%Gopālarājava{\dharmanusvara}śāvalī p. 124 Dharmadeva and a v{\dharmar}ṣa statue? Text mentions v{\dharmar}ṣadhvaja though...
%
%Pañcāvaraṇastava 71:
%pratyag āśāsthita{\dharmanusvara} vande v{\dharmar}ṣa{\dharmanusvara} ca v{\dharmar}ṣabhāk{\dharmar}tim|
%sākṣād dharma{\dharmanusvara} sita{\dharmanusvara} tryakṣa{\dharmanusvara} parameśasya vāhanam||
...
(3) genealogies (\skt{va{\dharmanusvara}śa});
(4) Manu eras (\skt{manvantara}s);
(5) history (\skt{va{\dharmanusvara}śānucarita}).%
		\footnote{See, e.g., \SivP\ 7.1.41: 
                        \skt{sargaś ca pratisargaś ca 
                                va{\dharmanusvara}śo manvantarāṇi ca |
                                va{\dharmanusvara}śānucarita{\dharmanusvara} caiva
                                purāṇa{\dharmanusvara} pa{\dharmanusvara}calakṣaṇam} ||.}
...
paraphrasing \MBh\ 1.56.21:%
        \footnote{\MBh\ 1.56.21 reads:
                 \skt{arthaśāstram ida{\dharmanusvara} puṇya{\dharmanusvara} dharmaśāstram ida{\dharmanusvara} param~|
                      mokṣaśāstram ida{\dharmanusvara} prokta{\dharmanusvara} vyāsenāmitabuddhinā ||}.
...
\skt{pādam ādyam}% 
		\footnote{Understand \skt{pādamātram}?}
							\skt{ida{\dharmanusvara} śāstra{\dharmanusvara} yo 'dhīyīta jitendriyaḥ |}\\
\skt{tenādhīta{\dharmanusvara} sarvvadharmmam iti nāsty atra sa{\dharmanusvara}śayaḥ ||}\\
\skt{arthaśāstram ida{\dharmanusvara} puṇya{\dharmanusvara} dharmmaśāstram ida{\dharmanusvara} para{\dharmanusvara}~|}\\
\skt{mokṣaśāstram ida{\dharmanusvara} prokta{\dharmanusvara} śivenāmitatejasā ||}
...
Dharma\-śāstra, and also a yogic text offering instructions on \skt{mokṣa}.
One could cautiously characterise the \VSS\ as a heterogeneous
text containing Dharma\-śāstric, Purāṇic, yogic, and narrative elements,
...
\phantomsection\section{Structure}\label{structure}
...
and a Śaiva layer. Fig.~\ref{fig:struct2021} is
...
Dharmaśāstric is a dialogue between king \enx{Janamejaya} and the sage
\enx{Vaiśampāyana}; the \enx{Vaiṣṇava} layer is presented as
a dialogue between \enx{Vigatarāga}, who is
\enx{Viṣṇu} in disguise, and \enx{Anarthayajña},\label{anarthayajna_person} the ascetic;
the Śaiva layer is a dialogue between \enx{Śiva} and \enx{Devī},
as related by Nandikeśvara.\myidx{Nandi, -in, -keśvara}

The transitions between the layers are smooth. 
That is to say, Nandi\-keśvara's\myidx{Nandi, -in, -keśvara} narrative
is mentioned, introduced, and told by \enx{Anarthayajña}, whose dialogue
with \enx{Vigatarāga} is in turn narrated to \enx{Janamejaya} by \mbox{\enx{Vaiśampāyana}.}

Another way to represent the overall structure of the \VSS\
visually is shown by Fig.~\ref{fig:structlotus} 
...
% end of CGPT section
\phantomsection\section{Connection to other texts and traditions}
\label{vss_connection_other_texts}
\phantomsection\subsection{\MBh\ and Purāṇas}
...
\phantomsection\subsection{Pāśupata and tantric influence}
...
Verses 8.35--43 describe various modes of ritual bathing. The first, Fire Bath, is explicitly referred to as a `Pāśupata observance' (\skt{vrata{\dharmanusvara} pāśupata{\dharmanusvara}}), and is praised as the most important (\skt{pāśupata{\dharmanusvara} śreṣṭha{\dharmanusvara}}) in verse 8.39. (Note that chapter eight, despite these influences, is part of a layer of the text that otherwise could be labelled as Vaiṣṇava.)%
...
As for any possible Mantramārgic or Saiddhāntika influence, Sadāśiva, Paraśiva, and Śiva as Paramātman are mentioned in 16.34 as corresponding to breaths.%
        ...
        they will not sigh again. [For this reason] it is known
         ...
         the bondage of being in \skt{sa{\dharmanusvara}sāra}'
         ...
         the title of the work as `compendium (\skt{sa{\dharmanusvara}hitā})
...
An obscure reference to a 36-\skt{tattva} system appears in 4.73, possibly indicating familiarity with a full-fledged tantric ontological system, in stark contrast with the highly detailed account and propagation of a 25-\skt{tattva}-system in chapter 20.%
			\footnote{\VSS\ 20.1ab: 
			\skt{pañcavi{\dharmanusvara}śati yat tattva{\dharmanusvara}
					jñātum icchāmi tattvataḥ} |
			\skt{kathayasva mamādya tva{\dharmanusvara}
					 chidyate yena sa{\dharmanusvara}śayaḥ} ||
...
Similary, the terms \skt{sakala-vikala} in 9.5 may betray some knowledge of Śaiva tantric theology. Mantras resembling those of the tantric Mantra\-mārga, apart from \skt{o{\dharmanusvara}}, are largely absent in the \VSS, however
...
6 \skt{mano'nu\-gā}, 7 \skt{suk{\dharmar}tā}, 8 \skt{saumyā}, 9 \skt{nirañjanā}, 10 \skt{nirālambā}---description
 breaks down after the sixth item) echo \titleface{Kubjikāmatatantra} 25.172ff:

\begin{quote}
\skt{athānyat sampravakṣyāmi avasthā{\dharmanusvara} jñānabodhikām} |\\
\skt{ghoṣaṇī piṅgalā caiva vidyunmālā ca candriṇī} ||25.172||\\
\skt{mano'nugā ca suk{\dharmar}tā saumyā caiva nirañjanā} |\\
\skt{nirālambā tathā devī anyā caiva mahābalā} ||25.173||\\
\end{quote}


%B{\dharmar}hatkālottara, Skanda?
...
Finally, the Pañcarātra tradition is mentioned several times (\VSS\ 10.33,
 16.36--37), but its presence, similar to some \MBH\ passages,%
			...
			(\skt{sā{\dharmanusvara}khya{\dharmanusvara} yoga{\dharmanusvara} pañcarātra{\dharmanusvara} vedāraṇyakam eva ca} |
		    \skt{jñānāny etāni brahmarṣe lokeṣu pracaranti ha} ||) with
		    \VSS\ 16.36 
		    (\skt{śāstrapañcasu yat prokta{\dharmanusvara}
				    		 ś{\dharmar}ṇu sa{\dharmanusvara}kṣepa nirṇayam} |
			\skt{sā{\dharmanusvara}khye yoge pañcarātre
...
\phantomsection\subsection{Śivadharma texts}
...
\skt{prathamā \textbf{sūrya}sa{\dharmanusvara}sthānā karṇikopari sa{\dharmanusvara}sthitā} |\\
\skt{yā caturvi{\dharmanusvara}śakā proktā yā ca śāktir iti sm{\dharmar}tā} ||4.6||\\
\skt{avidyeti ca yā khyātā sa{\dharmanusvara}sāre sukhabuddhidā} |\\
\skt{traiguṇyabhāvanilayā prak{\dharmar}tiḥ sābhidhīyate} ||4.7||\\
\skt{ida{\dharmanusvara} prak{\dharmar}tija{\dharmanusvara} sarva{\dharmanusvara} duḥkham ity avabhāvayet} |\\
\skt{upekṣate virāgātmā nirguṇaḥ kevalasthitaḥ} ||4.8||\\
\skt{sūryamaṇḍalamadhyasthaś \textbf{candra}maṇḍalasannibhaḥ} |\\
\skt{pañcavi{\dharmanusvara}śaka ity ukta puruṣaḥ so ’bhidhīyate} ||4.9||\\
\skt{kīd{\dharmar}k kim iti vā jñānam iti samyaṅ nirūpayet} |\\
\skt{mokṣajijñāsabhāvo yaḥ sa ṣaḍvi{\dharmanusvara}śakamaṇḍalam} ||4.10||\\
\skt{candramaṇḍalamadhyastho \textbf{vahni}jvālānibhāk{\dharmar}tiḥ} |\\
\skt{avidyādāvadagdho 'sau prabhur ity abhidhīyate} ||4.11||\\
\skt{sarvat{\dharmar}ṣṇāvinirmuktaḥ samaḥ sarveṣu sarvadā} |\\
\skt{k{\dharmar}tak{\dharmar}tyatayā yas tu jñānamātraikakevalam} ||4.12||\\
\skt{atyantanirmalaḥ svacchaḥ śuddha\textbf{sphaṭika}sannibhaḥ} |\\
\skt{agnimaṇḍalamadhyasthaḥ saptavi{\dharmanusvara}śaka ucyate} ||4.13||\\
\skt{akīrtitam anaupamya{\dharmanusvara} pañcama{\dharmanusvara} \textbf{śiva}maṇḍalam} |\\
\skt{vidyāmaṇḍalamadhyastham aṣṭāvi{\dharmanusvara}śakam ucyate} ||4.14||
\end{quote}
...
yoga (\skt{sa{\dharmanusvara}kṣipta}, \skt{viśālā}, \skt{dvikaraṇa}), are presented
...
\phantomsection\subsection{Buddhist influence}
...
possibly indicating only a superficial familiarity with the concept.%
	\footnote{Could this passage have been influenced by 
				...
				\skt{mokṣasy\textbf{āyatanāni} ṣaṭ~|
                                apramādas tathā śraddhā vīryārambhas tathā dh{\dharmar}tiḥ~|
                                jñānābhyāsaḥ sa{\dharmanusvara}tāśleṣo mokṣasyāyatanāni ṣaṭ}~||1.3||
			  \skt{nava śāntisamprāptihetavaḥ~|
  			  dāna{\dharmanusvara} śīla{\dharmanusvara} damaḥ kṣāntir
  			  \textbf{maitrī} bhūteṣv ahi{\dharmanusvara}satā~|
...
\phantomsection\section{Dating and provenance}
\label{provenance}
\enlargethispage{1.5em}
...
\skt{agnitīrtham iti khyāta{\dharmanusvara} yamunādakṣiṇe taṭe}; and
\PadmaP\  6.139.1ab:    
\skt{sābhra\-maty\-uttare kūle agnitīrtham iti śrutam}; 
...
\skt{somatīrtha{\dharmanusvara} tato gacched gupta{\dharmanusvara} sābhramatītaṭe}.
...
\begin{quote}
\skt{ki{\dharmanusvara}ciddūre saṅgamasya yajñabhūmi{\dharmanusvara} manoharām} |\\
\skt{vidhāya munibhir sārddha{\dharmanusvara} vājapeyam athākarot} || 3.21\\
\skt{yajña{\dharmanusvara} samāpya vālmīkir navanāḍīmaya{\dharmanusvara} girim} |\\
\skt{āruroha dvijaśreṣṭho munibhir munisattamaḥ} || 3.22\\
\skt{kaṭake tasya śailasya nānānirjharaśobhite} |\\
\skt{liṅga{\dharmanusvara} sa{\dharmanusvara}sthāpayām āsa vālmīkīśvarasa{\dharmanusvara}jñitam} || 3.23\\
\skt{sthāpayitvā mahāliṅga{\dharmanusvara} vālmīkir munisattamaḥ} |\\
\skt{svāśrame tamasātīre yayau munigaṇair v{\dharmar}taḥ} || 3.24\\
\skt{vālmīkīśvaram ālokya vāgvibhūtiḥ prajāyate} |\\
\skt{ato vāgīśvara{\dharmanusvara} liṅga pravadanti manīṣiṇaḥ} || 3.25
...
completed the sacrifice,\linebreak
Vālmīki, the best of
the twice-born, the truest of sages,\linebreak
climbed the mountain on which fresh grass was growing(?)%
	\footnote{\skt{navanāḍīmaya{\dharmanusvara}}. Emend to
	\skt{navanadīmaya{\dharmanusvara}} (`having nine rivers')?}
...
\mycite{AcharyaNepalaMahatmya} as Fig.~\ref{fig:map02}
...
\begin{quote}
\skt{devatānā{\dharmanusvara} hariḥ śreṣṭhaḥ śreṣṭhā gaṅgā nadīṣu ca} |\\
\skt{anāśanas}%
...
All the above is based on \VSS\ chapter ten. All locations have
 been entered in the map which is Fig.~\ref{fig:map01} on
 p.~\pageref{fig:map01}.
 ...
 in Maharashtra.%
	\footnote{The city we are looking for is clearly in
						...
						\skt{pūrvajais tava govinda
									 pūrva{\dharmanusvara} puram ida{\dharmanusvara} k{\dharmar}tam} |\\
						\skt{karavīrapura{\dharmanusvara} nāma
									rāṣṭra{\dharmanusvara} caiva niveśitam} ||\\
						\skt{pure 'smin n{\dharmar}patiḥ k{\dharmar}ṣṇa
									vāsudevo mahāyaśāḥ} |\\
						\skt{s{\dharmar}gāla iti vikhyāto
								nitya{\dharmanusvara} paramakopanaḥ} ||\\
...
in the \VSS\ is M{\dharmar}gendra\-śikhara,\label{anarthayajnas_asrama} where Anarthayajña's \skt{āśrama} is situated,
`on the southern slopes of the Himalayas.'%
		\footnote{\label{mrgendrasikhara}See \VSS\ 22.4--5:\\
     		\skt{vaiśampāyana uvāca~|\\
			ś{\dharmar}ṇu rājann avahito yogendrasya mahātmanaḥ~|\\
		    āśrama{\dharmanusvara} varṇajātīnā{\dharmanusvara} vakṣyāmy eva narādhipa~||\\
			himavaddakṣiṇe pārśve m{\dharmar}gendraśikhare n{\dharmar}pa~|\\
			...
			`Vaiśampāyana spoke: Listen, O King, attentively.
		  	...
		  	on the M{\dharmar}gendra peak, O king,
...
(Fig.~\ref{fig:map02}). M{\dharmar}ge\-ndra\-śikhara is a mountain
...
who is attacked by king Ha{\dharmanusvara}sadhvaja, the ruler of Mithilā. Sūryaketu is advised by Nārada
to go and hide at M{\dharmar}gendraśikhara (\NepMah\ 7.48):

\begin{quote}
\skt{nārada uvacā} |\\
\skt{m{\dharmar}gendraśikhara{\dharmanusvara} gatvā nivāsa{\dharmanusvara} kuru pārthiva} |\\
\skt{yatrotpannā mahāramyā vāgvatī saritā{\dharmanusvara} varā} |\\
\skt{tasmin sthāne sugupta{\dharmanusvara} ca nivāsa{\dharmanusvara} kuru bhūpate} ||

Nārada spoke:
Go to M{\dharmar}gendraśikhara, O king, and stay there.
O king, set up your hiding place there
where the beautiful Vāgvatī, the best of rivers, rises.
\end{quote}

\noindent
Nārada goes on to describe legends connected to M{\dharmar}gendraśikhara.
After Viṣṇu assumed his (half-man, half-)lion-form and killed Hiraṇyakaśipu,
he retreated to the Himālayas. 
The part of the mountain where Viṣṇu stayed is called M{\dharmar}gendraśikhara exactly
...
\Vagmati.%
        ...
        in \NepMah\ chapter eight, we find Sūryaketu still dwelling at M{\dharmar}gendraśikhara.
        Now the demon Mehendradamana wants to marry his daughter...
        See details on the identification and
        on legends in the \NepMah\ and the \Vagmati\ connected to M{\dharmar}gendraśikhara in
...
called Indramārga in the valley of M{\dharmar}gendraśikhara.
...
\begin{figure}[!]
\leftskip-1em\includegraphics[scale=.33]{images/simplemap.png}
...
is connected strong\-ly suggests the Kathmandu 
...
time of composition of the text include King Si{\dharmanusvara}hajaṭa
...
what Olivelle calls the `Northern\linebreak

\vfill
\pagebreak
\noindent
Transmission.'%
		\footnote{See, e.g., \skt{pāpak{\dharmar}t} in \VSS\ 3.34d
...
dated to Nepal Sa{\dharmanusvara}vat 156, i.e., 1035-36~\CE.%
...
that used for some of the other texts in that MS.%
		...
		\textit{Uttaromāmaheśvarasa{\dharmanusvara}vāda}* (24 folios),
		the \textit{V{\dharmar}ṣasārasa{\dharmanusvara}graha} (50 folios), and the
...
\phantomsection\section{Language}\label{language}

\phantomsection\subsection{Newar influence?}
\label{newar}
...
other local Prāk{\dharmar}ts may also have played a role.)
...
\phantomsection\subsection{Number and gender}\label{number}
...
in number and gender.%
	...
	`Newarized Sanskrit' (\citeyear{KolverErgative}, 202) in the \SvayP\ thus (ibid. 192):
			...
			[\skt{tvam ekam āgata{\dharmanusvara} na hi} 464, 10 `only you have not come’;
			\skt{°nāgakanyā \dots\ v{\dharmar}ṣṭipūrṇa{\dharmanusvara} k{\dharmar}tam} 470, 8
...
\begin{quote}
\skt{rātryāgame pralīyante jagat sarva{\dharmanusvara} carācaram}
...
\begin{quote}
\skt{pañcapramādam{ }etāni varjanīya{\dharmanusvara} dvijottama}

These five kinds of mistakes are to be avoided, O great Brah\-min.
\end{quote}
...
\begin{quote}
\skt{pramāṇa{\dharmanusvara} nāma sa{\dharmanusvara}khyā ca kīrtitāni samāsataḥ}
...
\begin{quote}
        \skt{anudvegakarā vāṇī priya{\dharmanusvara} satya{\dharmanusvara} hita{\dharmanusvara} ca yat} (\VSS\ 6.21ab)

        \skt{anudvegakara{\dharmanusvara} vākya{\dharmanusvara} priya{\dharmanusvara} satya{\dharmanusvara} hita{\dharmanusvara} ca yat} (\BHG\ 17.15ab)
...
\begin{quote}
\skt{parva cāsya śata{\dharmanusvara} pūrṇa{\dharmanusvara} śrutvā bhāratasa{\dharmanusvara}hitām}
...
\noindent
Here, one would expect either a plural genitive \ie{parvāṇā{\dharmanusvara} śata{\dharmanusvara}},
a compound \ie{śataparvāṇi}, or a plural accusative \ie{parvāṇi śata{\dharmanusvara}}.
...
trigger the same: \skt{gatis tasya kati sm{\dharmar}tāḥ} (3.1d; `how many are its path[s]?').
...
plural ending. This again is what we often observe in Newar.%
		...
		E.g.: in the Newar phrase \skt{thwo khu{\dharmanusvara}-na khaṅ-ā rājā-pani}
...
line in standard Sanskrit, e.g., beginning with \skt{kīrtita{\dharmanusvara} ca\dots}
...
\Manu\ 11.55, a verse that also features in the \MBH\ and in the \YajnS.%
                \footnote{\MANU\ 11.55 (in Olivelle's edition):
                    \skt{brahmahatyā surāpāna{\dharmanusvara} steya{\dharmanusvara} gurvaṅganāgamaḥ |
                         mahānti pātakāny āhuḥ sa{\dharmanusvara}sargaś cāpi taiḥ saha ||};
                          \MBH\ Suppl. 12.30:
                    \skt{brahmahatyā{\dharmanusvara} surāpāna{\dharmanusvara} steya{\dharmanusvara} gurvaṅganāgamam |
                         mahānti pātakāny āhuḥ sa{\dharmanusvara}yoga{\dharmanusvara} caiva taiḥ saha ||};
                          \YAJNS\ 3.228:
                    \skt{brahmahā madyapaḥ stenas tathaiva gurutalpagaḥ |
                            ete mahāpātakino yaś ca taiḥ saha sa{\dharmanusvara}vaset ||}.}
...
which prefers a singular.%
                \footnote{\VSS\ 4.77:
               \skt{brahmahatyā surāpāna{\dharmanusvara} steyo gurvaṅganāgamam |
                    mahāpātakam ity āhus tatsa{\dharmanusvara}yogī ca pañcamaḥ ||}.}
...
\phantomsection\subsection{Case and syntax}
...
\skt{\phantom{aaa}sam{\dharmar}ddhasasyo jalasa{\dharmanusvara}nik{\dharmar}ṣṭaḥ} |\\
...
\skt{dvijāya hīnadīnāya sasyasam{\dharmar}ddhā{\dharmanusvara} jalasa{\dharmanusvara}ni\-k{\dharmar}ṣṭā{\dharmanusvara} bhūmi{\dharmanusvara} yo dadāti}.
...
\begin{quote}
\skt{indreṇāsmi phala{\dharmanusvara} datta{\dharmanusvara} sa phala{\dharmanusvara} datta me bhavān}
...
\skt{indreṇa phala{\dharmanusvara} datta{\dharmanusvara}}, but then, instead of adding a dative or
genitive (e.g., \skt{indreṇa me phala{\dharmanusvara} datta{\dharmanusvara}}), the author chooses
a finite verb (\skt{asmi}). In \skt{pāda} d, after seemingly 
treating \skt{phala{\dharmanusvara}} as a masculine noun, and leaving
...
the dative or genitive. Why not write \skt{datta{\dharmanusvara} tad eva te mayā},%
		\footnote{Although this solution carries the metric fault of being iambic.}
or \skt{datta{\dharmanusvara} tava tad eva ca}?
...
\begin{quote}
\skt{brahmaṇā kathita{\dharmanusvara} pūrṇa{\dharmanusvara} mātariśvā yathātatham}\\
\skt{vāyunā pāda sa{\dharmanusvara}kṣipya prāpta{\dharmanusvara} cośanasa{\dharmanusvara} purā}
...
\skt{bravīmi vaḥ purāv{\dharmar}tta{\dharmanusvara} nandinā kathito 'smy aham}
...
becomes an accusative \ie{uśanasa{\dharmanusvara}}. Thirdly,
\skt{kathito 'smi} stands for \skt{kathita{\dharmanusvara} mama} or
\skt{kathita{\dharmanusvara} mahyam}.
...
\skt{āgneyadhātu{\dharmanusvara} soma{\dharmanusvara} ca kathito 'smi varānane}
...
as `I did not know.'%
		\footnote{\mycitep{JorgensenVicitra}{77 and 328}.\label{najnatohamfn}
						Compare \skt{tat phala{\dharmanusvara} sa niveditaḥ} (`he gave that fruit') in \VSS\ 12.67d.}

%Vicitrakar :
%ibid and 66 \skt{aṣṭhan/au divasam āgata} should mean `Come on the eighth day'.;
%buddhamārga{\dharmanusvara} abhijñāta{\dharmanusvara}: `on the well-known path of the Buddhas'
%80 and 328-329 samagra{\dharmanusvara}, stem forms etc.!?
...
\skt{dhanyās te yair ida{\dharmanusvara} vetti}, `fortunate are those who know this' (4.75ab),
...
\begin{quote}
\skt{caturmaunasya vakṣyāmi ś{\dharmar}ṇuṣvāvahito bhava}
...
a word like \skt{la\-kṣa\-ṇa{\dharmanusvara}} or \skt{svabhāva{\dharmanusvara}}
(`the characteristics/\thinspace essence [of X]') is missing. 1.37ab and 4.17ab
display similar structures:

\begin{quote}

\skt{brahmāṇḍānā{\dharmanusvara} prasa{\dharmanusvara}khyātu{\dharmanusvara} mayā śakya{\dharmanusvara} katha{\dharmanusvara} dvija}

How could I enumerate [all the details of] the Brahmāṇḍa[s], O twice-born?

\skt{eva{\dharmanusvara} satyavidhānasya kīrtita{\dharmanusvara} tava suvrata}
...
classical Newar would usually also require an extra word (such as \skt{kha{\dharmanusvara}} `thing, topic, word, story')
...
\phantomsection\subsection{Cardinal and ordinal numbers}

Although the \VSS\ does use simple ordinal numbers such 
as \skt{prathama}, \skt{dvi\-tī\-ya}, and \skt{t{\dharmar}tīya}, with higher
...
\begin{quote}
\skt{caturvi{\dharmanusvara}śati yat{ }tattva{\dharmanusvara} prak{\dharmar}ti{\dharmanusvara} viddhi niścayam}\\
\skt{dvāvi{\dharmanusvara}śati aha{\dharmanusvara}kāras{ }tattvam{ }ukta{\dharmanusvara} manīṣibhiḥ}

Know the twenty-fourth Tattva certainly as Prak{\dharmar}ti.
The twenty-second Tattva is Aha{\dharmanusvara}kāra according to the wise.
\end{quote}
...
\phantomsection\subsection{Stem form nouns}\label{stemform}
...
\begin{quote}
1.63a: \skt{vāyunā pāda sa{\dharmanusvara}kṣipya} (\skt{pāda{\dharmanusvara}}) \\
1.63c: \skt{tenāpi pāda sa{\dharmanusvara}kṣipya} (\skt{pāda{\dharmanusvara}}) \\
2.25c: \skt{bhogam akṣaya tatraiva} (\skt{akṣaya{\dharmanusvara}}) \\
2.26d: \skt{īśānānā{\dharmanusvara} sm{\dharmar}tālayaḥ} (\skt{sm{\dharmar}ta ālayaḥ}) \\
4.19f: \skt{prasahyasteya pañcamam} (°\skt{steya{\dharmanusvara}}) \\
4.72a: \skt{caturdhyānādhunā} (°\skt{dhyānam adhunā}) \\
4.77a: \skt{pramādasthāna pañcaiva} (°\skt{sthāna{\dharmanusvara}} or °\skt{sthānāni})
 \\
6.5c: \skt{vedādhyayana kartavya{\dharmanusvara}} (\skt{vedādhyayana{\dharmanusvara}}) \\
6.14a: \skt{dvitīya{\dharmanusvara} tattva puruṣa{\dharmanusvara}} (\skt{tattva{\dharmanusvara}}) \\
\end{quote}
...
\phantomsection\subsection{A list of notable grammatical phenomena}

This is a list of notable grammatical phenomena in \VSS\ 1--12. It is not exhaustive, and
many categories overlap and are open to different interpretations.
...
-- absence of \skt{sandhi}, 4.22, 4.58, 7.27, 8.5, 10.10

-- absence of \skt{sandhi} within a \textit{pāda}, 4.31c, 9.37c

-- irregular \skt{sandhi}, 4.26

-- \skt{sandhi} \skt{a-m-a} instead of \skt{o '}\ , 4.29, 12.8

-- double \skt{sandhi}, 2.19, 12.145

-- \skt{sandhi} bridge, hiatus-filler, 1.36, 2.25, 2.29, 3.15, 3.39, 4.2, 4.28, 4.51, 4.67, 5.1, 5.20, 8.9, 11.1, 11.20, 11.39, 12.3, 12.68

-- \skt{r} as \skt{sandhi} bridge?, 1.26, 4.67
...
-- nominative for instrumental, agent-verb discord, 11.3?, 12.132

-- nominative for genitive, 4.59

-- nominative inside compound, 4.29

-- \skt{gāvaḥ} (nom. plur.) for \skt{gāḥ} (acc.),%
                \footnote{\mycitep{OberliesEpicSkt}{2.15 [p.~68]}.}
7.26 
...
-- plural accusative -\skt{ā{\dharmanusvara}} for -\skt{ān} 12.128, 12.144




-- instrumental + finite verb (ergative), 1.3, 8, 75, 4.75, 12.60

-- instrumental for ablative, %Newari lack of ablative? 
                        2.1

-- instrumental for locative, 1.55



-- genitive for accusative, 4.31b

-- genitive for ablative? (\skt{tava}), 4.18
...
-- locative for genitive, 8.42, 11.13

-- locative or genitive for ablative, %(\skt{cakṣusor}), 
                                4.54
...
-- gender confusion, 1.14, 29, 2.20, 2.25, 3.16, 6.9, 4.59, 4.82, 5.17, 9.3, 9.37

-- gender and case confusion, 2.18, 11.16

-- gender and number confusion, 1.61

-- masculine locative for feminine locative, % (\skt{vele} for \skt{velāyā{\dharmanusvara}})
                        8.22
...
-- number confusion, 2.19, 4.82, 11.22, 12.29
...
-- singular after numerals, 1.2, 1.39, 1.43, 1.47, 3.1, 3.5--6, 3.17, 4.77, 6.23, 6.2, 6.20, 8.1?, 8.19, 8.30, 8.44, 10.16, 12.145
...
-- confused syntax, 1.70, 8.44, 12.112

-- \skt{datto 'smi} instead of \skt{datta{\dharmanusvara} mama}, 12.84

-- odd syntax: \skt{aham asmi phala{\dharmanusvara} datta{\dharmanusvara}}, 12.108, 113

-- only last element of noun phrase has plural ending, 3.8
...
-- with \skt{pr}, 2.40a, 4.89a, 6.13a, 11.9a
...
%-- misplaced \skt{ādi} (emended) 9.28


%-- possible Newar influence? 1.74 % 13.46
%Newari biye? 17.1
...
%-- singular nominative for plural genitive 20.60
...
-- intrusive -\skt{r}- in compound metri causa, 11.27

-- inverted compounds, 10.30

\vfill
\pagebreak
Stem form nouns and adverbs:

-- stem form nouns, 1.22, 1.48, 2.25--26, 2.35, 4.19, 4.30, 4.59, 4.7?, 4.72, 4.73, 4.77, 6.26, 11.14--16, 11.19--20, 11.22, 11.28, 11.36, 12.10

-- stem form nouns metri causa, 1.43, 1.49, 1.63, 1.63, 6.10, 6.14, 6.19, 6.20, 6.23, 6.28, 6.28, 6.5, 7.1, 7.13, 7.2, 7.27, 7.27, 8.13, 8.33, 8.44, 9.15, 10.12, 10.23, 10.31--33, 10.34, 11.18, 11.21, 11.27, 11.37, 11.58, 
12.16, 29, 63, 69, 74, 109, 110, 113, 123, 128, 130, 151
 
-- stem form noun for accusative, 11.17

-- stem form noun or split \skt{sandhi}, 3.10

%-- stem form plus licence śva 21.28


-- stem form in \skt{sandhi} with verb metri causa, 12.52

-- stem form or double \skt{sandhi}, 12.9, 20.24--25, 12.64
...
-- \skt{katama} not declined as a pronoun, 10.1

-- \skt{kaścana} for \skt{ka{\dharmanusvara}cana}, 12.49, 55

-- \skt{tebhyaḥ} as masculine for feminine, 3.8

-- \skt{tubhyam} as instrumental, 12.96, 12.101, 12.150%
                \footnote{\mycite{Oberlies}{4.2.2 [pp. 104]}.}

-- \skt{te} used as \skt{tvayā}, 1.13

-- \skt{tvad} for  \skt{tava}, 12.151

-- \skt{tvad} for \skt{tvā{\dharmanusvara}}?, 12.103

-- \skt{tvayi} for \skt{tvayā} (corrected), 12.36

-- \skt{me} instead of \skt{mayā}, 8.30, 11.4, 12.24, 55, 113% 
        \footnote{See \mycitep{OberliesEpicSkt}{4.1.3 [pp. 102--103]}.}

-- \skt{vaḥ} as ablative % (not in Oberlies) i
                        or instrumental, 1.31
...
-- metri causa 4.52, 10.34, 12.3, 7, 12, 28, 68 



\phantomsection\subsection{Vocabulary}

\noindent
The special vocabulary of the \VSS\ includes the following:

--  \skt{ananta} meaning `ten quadrillion' (\skt{anta} in 1.33c);
        
--  \skt{ālayana} for \skt{ālaya} (possibly 2.3a);

--  \skt{āsamagra} in an uncertain meaning (possibly 1.1c);

--  \skt{āhūta}[\skt{sa{\dharmanusvara}}]\skt{plavana} for \skt{ā\-bhūta}[\skt{sa{\dharmanusvara}}]\skt{plavana} (2.13a, 12.151b);
...
--  \skt{śaśi} for \skt{śaśin} (thematisation, 6.8c, 12.110d).

--  \skt{śriya} for \skt{śrī} (12.143b);

--  \skt{śreṣṭhi} for \skt{śreṣṭhin} (thematisation, 12.63a, 12.80a);

--  \skt{h{\dharmar}di} as nominative 10.27cd, 20.17a, 22.24ab;%
...
\phantomsection\subsection{Metre}\label{metre}
\label{muta}
...
before certain consonant clusters that would normally make it heavy \ie{guru}.%
		\footnote{On its appearance in Śaiva Tantras,
							...
							\skt{sparśatanmātra sparśan tu g{\dharmar}hṇate tvacam āś{\dharmar}taḥ}. }
...
I therefore propose the terms `\krama\ licence' or \skt{kramasa{\dharmanusvara}yoga}.
...
phenomenon in his
\skttitle{V{\dharmar}ttaratnākara}{Vrttaratnakara} (here given together with Sulhaṇa's
\skttitle{Sukavih{\dharmar}dayanandinī}{Sukavihrdayanandini} commentary):%
		\footnote{\mycite{PatelVrttaratnakara}.}

\begin{quote}
\skt{padādāv}%
                \footnote{Some editions read \skt{pādā}°.}
\skt{iha varṇasya sa{\dharmanusvara}yogaḥ kramasa{\dharmanusvara}jñikaḥ} | \\
\skt{puraḥsthitena tena syāl laghutā 'pi kvacid guroḥ} || 1.10 ||

In this [field, i.e., in \skt{chandaḥ\-śāstra}], conjunct consonants
\ie{sa{\dharmanusvara}\-yoga} in a word-initial syllable \ie{padādau varṇasya} is
called a `sequence' conjunct (\skt{kra\-ma}[\skt{sa{\dharmanusvara}yoga}]).
...
{\footnotesize [Comm.:] 
\skt{vibhaktyanta{\dharmanusvara} pada{\dharmanusvara} tasya padasyādau vartamāno yo varṇas tasya
sa{\dharmanusvara}\-yogaḥ}~|
\skt{sa iha śāstre kramasa{\dharmanusvara}jño jñeyaḥ}~|
...
\skt{nanu ka eṣaḥ kramo nāma sa{\dharmanusvara}yoga ucyate}~|
\skt{pūrvācā\-ryāṇā{\dharmanusvara} piṅgalanāgaprabh{\dharmar}tīnā{\dharmanusvara} kāli\-dāsādīnā{\dharmanusvara} ca
kavīnā{\dharmanusvara} samayaḥ parig{\dharmar}hītaḥ}~|~\skt{sa{\dharmanusvara}yogaḥ kramasa{\dharmanusvara}yogaḥ}
||~10~||
\skt{tatra gra-sa{\dharmanusvara}\-yo\-gena yathā}~|
...
accepted [this] rule. The conjunct \ie{sa{\dharmanusvara}yoga}
is the sequence[-type] \ie{\krama} [i.e., word-initial]
conjunct \ie{sa{\dharmanusvara}yoga} [in this case]; among [the possibilities,] for example with the conjunct \skt{gr}.
Here is an example of that:}

\skt{taruṇa{\dharmanusvara} sarṣapaśāka{\dharmanusvara} navaudana{\dharmanusvara} picchalāni ca dadhīni}~|\\
...
is not turned into heavy, are encircled, and the intended metre is given in 
parentheses.

\begin{table}[h]
    \begin{tabular}{ll}
1.1c: & \skt{harīndra\Circled{bra}hmādibhir āsamagra{\dharmanusvara}} (\skt{upajāti})\\
2.40ab: & \skt{kālena sama\Circled{pre}ṣyeṇa dharmo yāti parikṣayam} (\skt{pathyā})\\
4.67c: & \skt{prajñābodha\Circled{śru}ti{\dharmanusvara} sm{\dharmar}ti{\dharmanusvara} ca labhate māna{\dharmanusvara} ca}\\
                & \skt{nitya{\dharmanusvara} labhed} (\skt{śārdūlavikrīḍita})\\
4.89a: & \skt{iti yama\Circled{pra}vibhāgaḥ kīrtito 'ya{\dharmanusvara} dvijendra} (\skt{mālinī})\\
5.5cd: & \skt{parastrīpara\Circled{dra}vyeṣu śauca{\dharmanusvara} kāyikam ucyate} (\skt{pathyā})\\
5.9cd: & \skt{vānaprasthasya \Circled{tri}guṇa{\dharmanusvara} yatīnā{\dharmanusvara} tu caturguṇam}\\
                &  (\skt{na-vi\-pulā})\\
5.15ab: & \skt{ha{\dharmanusvara}sasārasacakrāhvakukkuṭān śuka\Circled{śye}nakān} (\skt{pathyā})\\
6.13ab: & \skt{brahmaloka{\dharmanusvara} tu \Circled{pra}thama{\dharmanusvara} tattvaprak{\dharmar}ticintayā}\\
                & (\skt{na-vi\-pulā})\\
8.33a: & \skt{tasmān mauna\Circled{vra}ta{\dharmanusvara} sadaiva sud{\dharmar}ḍha{\dharmanusvara} kurvīta}\\
                & \skt{yo niścita{\dharmanusvara}}
 (\skt{śārdūla\-vikrīḍita})\\
10.31b: & \skt{īśānenābhijuṣṭa{\dharmanusvara} h{\dharmar}di \Circled{hra}da vimala{\dharmanusvara}}\\
                & \skt{nādaśītāmbu\-pū\-rṇam} (\skt{srag\-dharā})\\
11.9ab: & \skt{manaḥśuddhis tu \Circled{pra}thama{\dharmanusvara} dravyaśuddhir}\\
                & \skt{ataḥ param} (\skt{na-vipulā})\\
11.33cd: & \skt{adhidaivikam{ }ācāryo vyavasāyāś{ }ca \Circled{bhrā}taraḥ} (\skt{pathyā})
        \end{tabular}
\end{table}
...
turned heavy encircled:%
        \footnote{Versions of \VSS\ 4.5a in the \MBH\ and the \MatsP\
                  read °\skt{yukta{\dharmanusvara} vacana{\dharmanusvara}}, avoiding the metrical
                  problem (see the apparatus at the relevant verse in the edition).}


\begin{table}[h]
    \begin{tabular}{ll}
3:42d: & \skt{etatpuṇyapha\Circled{la}m ahi{\dharmanusvara}sakajanaḥ prāpnoti}\\
                & \skt{niḥsa{\dharmanusvara}śayaḥ} (\skt{śā\-rdū\-la\-vikrī\-ḍita})\\
4.5a: & \skt{na narmayu\Circled{kta}m an{\dharmar}ta{\dharmanusvara} hinasti} (\skt{upajāti})\\
4.39c:&\skt{aśeṣaya\Circled{jña}tapadānapuṇya{\dharmanusvara}}  (\skt{upajāti})\\
...
6.18b:  & \skt{jijñāsyantā{\dharmanusvara} dvijen\Circled{dra} bhavadahanakaraḥ prārthanā}\\
        & \skt{ka\-lpa\-v{\dharmar}kṣaḥ} (\skt{sragdharā})\\
7.13b:  & \skt{saubhā\Circled{gya}m atula{\dharmanusvara} labheta sa naro rūpa{\dharmanusvara} tathā}\\
        & \skt{śobhanam} (\skt{śā\-rdū\-la\-vikrīḍita})\\
8.44d:  & \skt{na bhavati punaja\Circled{nma} kalpakoṭyāyute 'pi} (\skt{mālinī})\\
11.42b: & \skt{sa{\dharmanusvara}sāroddhara\Circled{ṇa}m anityahara\Circled{ṇa}m}\\
        & \skt{ajñānanirmūlanam} (\skt{śā\-rdū\-la\-vikrīḍita})\\
11.42c: & \skt{prajñāv{\dharmar}ddhika\Circled{ra}m amoghakaraṇa{\dharmanusvara}}\\
        & \skt{kleśārṇavottāraṇa{\dharmanusvara}} (\skt{śā\-rdū\-la\-vikrīḍita})\\
11.42d: & \skt{janmavyādhiha\Circled{ra}m akarmadahana{\dharmanusvara}}\\
        & \skt{sevet sa dharmottamam} (\skt{śā\-rdū\-la\-vikrīḍita})\\
12.150c:& \skt{nitya{\dharmanusvara} rogādhivā\Circled{sa}m aniyatavapuṣa{\dharmanusvara}}\\
        & \skt{trāhi mā{\dharmanusvara} kāla\-pāśāt} (\skt{srag\-dharā})
         \end{tabular}
\end{table}
...
if meter requires a short final syllable, but \skt{{\dharmanusvara}} if a long is
...
\msM\ writes \skt{anityaharaṇa{\dharmanusvara}}, °\skt{v{\dharmar}ddhkara{\dharmanusvara}}
and °\skt{vyādhihara{\dharmanusvara}} in 11.42 before vowels (but not
\skt{sa{\dharmanusvara}sāroddharaṇa{\dharmanusvara}}!). The same MS has neither
\skt{{\dharmanusvara}} or \skt{m} in 12.150c (°\skt{vāsa aniyata}°).
One could argue that this lack of awareness of \skt{{\dharmanusvara}} before
a vowel indicating \skt{gurutva} in almost all cases in all MSS
are `mere corruptions of tradition,' and then typesetting
such -\skt{m} + vowel combinations as \skt{-{\dharmanusvara}} + vowel
...
\phantomsection\section{Authors, redactors and target audience}
...
the \SDhS\ and the \SDhU.%
        ...
        chapter eleven uses the terms \skt{śivag{\dharmar}hāśramin}, \skt{śivabrahmacārin},
        \skt{śivavaikhānasa} and \skt{śivavratīndra},
        while the \SDhU\ 12.203--207 uses \skt{śivabrahmacārin}, \skt{śivāśramadharmasthaḥ}
        \skt{g{\dharmar}hasthaḥ}, \skt{śivāśramavanastha}, and for the fourth category both the terms \skt{pāśupata} and
...
\phantomsection\section{Why was the \VSS\ included in the Śivadharma corpus?}
...
The \VSS\ may have already been existence, most probably in the\linebreak
Kathmandu valley, well before the beginning of the tenth century (see p.~\pageref{provenance}ff).
...
%%% CG start %%%
\phantomsection\section{Contents of chapters 1--12}\label{contentsof1_12}
...
\phantomsection\subsection*{Adhyāya 1}\label{contents_of_ch01}
After a \skt{maṅgala}-verse that addresses a 
deity whose identity is obscure
...
non-material, i.e., internalised, sacrifice (\skt{an\-artha\-ya\-jña}, 
...
ambiguous definition of the impersonal Brahman and/or the syllable \skt{o{\dharmanusvara}}.
...
\phantomsection\subsection*{Adhyāya 2}\label{contents_of_ch02}
...
subdivided into the thirty-eight \skt{kalā}s of the five Brahma\-mantras.
...
\phantomsection\subsection*{Adhyāya 3}\label{contents_of_ch03}
...
Dharma is declared to be the embodiment of Śruti and Sm{\dharmar}ti (3.14--15).
Sm{\dharmar}ti is described as concerning the \skt{varṇāśrama}-system, as well as
rules of conduct, i.e., the \skt{yama} and \skt{niyama} rules, which are the
focus of 3.16--8.44. Each rule is five-fold.
The \skt{yama}s are: \skt{ahi{\dharmanusvara}sā, satya, asteya, ān{\dharmar}śa{\dharmanusvara}sya, dama, gh{\dharmar}ṇā,
...
\YogaS,%
		\footnote{See, e.g., \MBh\ 12.8.17ab: 
						\skt{ahi{\dharmanusvara}sā satyavacanam ān{\dharmar}śa{\dharmanusvara}sya{\dharmanusvara} damo gh{\dharmar}ṇā}.
...
%śaucam ijyā tapo dāna{\dharmanusvara} svādhyāyopasthanigrahaḥ ||
%vratopavāso mauna{\dharmanusvara} ca snāna{\dharmanusvara} ca niyamā daśa ||202 ||
		\footnote{\VDHU\ 3.233.203:
				\skt{ān{\dharmar}śa{\dharmanusvara}sya{\dharmanusvara} kṣamā satyam ahi{\dharmanusvara}sā ca damaḥ sp{\dharmar}hā} |
				\skt{dhyāna{\dharmanusvara} prasādo mādhurya{\dharmanusvara} cārjava{\dharmanusvara} ca yamā daśa} ||.
...
non-violence (\skt{a\-hi{\dharmanusvara}sā}), focusing particularly on the five kinds of violence (3.18--23).
...
\phantomsection\subsection*{Adhyāya 4}\label{contents_of_ch04}
...
The fourth \skt{yama}, absence of hostility (\skt{ān{\dharmar}śa{\dharmanusvara}sya}), is
...
The sixth \skt{yama}, concerning taboos (\skt{gh{\dharmar}ṇā}) is addressed in verses 4.60--67.
...
\phantomsection\subsection*{Adhyāya 5}\label{contents_of_ch05}
...
\phantomsection\subsection*{Adhyāya 6}\label{contents_of_ch06}
...
\phantomsection\subsection*{Adhyāya 7}\label{contents_of_ch07}
...
\phantomsection\subsection*{Adhyāya 8}\label{contents_of_ch08}
...
Śaivism, Sā{\dharmanusvara}khya philosophy, the Purāṇas, Smārta texts (i.e., Dharmaśāstra),
and the \MBh\ (8.1). Śaivism is defined through the dichotomy of the Śaiva and Pāśupata
traditions. The Sā{\dharmanusvara}khya-\skt{tattva}s are said to be taught in groups of five,
...
\phantomsection\subsection*{Adhyāya 9}\label{contents_of_ch09}
...
\phantomsection\subsection*{Adhyāya 10}\label{contents_of_ch10}
...
\phantomsection\subsection*{Adhyāya 11}\label{contents_of_ch11}
...
\phantomsection\subsection*{Adhyāya 12}\label{contents_of_ch12}
...
\phantomsection\section{Topics in chapters 13--24}\label{contentsof12_24}
...
\phantomsection\subsection*{Adhyāya 13}\label{contents_of_ch13}
...
The reply that follows touches upon the three Sā{\dharmanusvara}khya categories \skt{prāk{\dharmar}ta}-, \skt{vaik{\dharmar}ta}-, and \skt{dakṣiṇābandha}---and
...
\phantomsection\subsection*{Adhyāya 14}\label{contents_of_ch14}
...
Then the reasons why a child is born male, female, or gender-neutral \ie{apu{\dharmanusvara}s} are given:
...
\phantomsection\subsection*{Adhyāya 15}\label{contents_of_ch15}
...
\phantomsection\subsection*{Adhyāya 16}\label{contents_of_ch16}
...
Sā{\dharmanusvara}khya, Yoga, the Pañcarātra, the Śaiva revelation, and Vedic knowledge (echoing and altering \MBh\ 12.336.1).
...
\phantomsection\subsection*{Adhyāya 17}\label{contents_of_ch17}
...
\phantomsection\subsection*{Adhyāya 18}\label{contents_of_ch18}
...
\phantomsection\subsection*{Adhyāya 19}\label{contents_of_ch19}
...
\phantomsection\subsection*{Adhyāya 20}\label{contents_of_ch20}
This chapter deals with a \MBh-type 25-\skt{tattva} ontological system,
as opposed to a Classical Sā{\dharmanusvara}khya-type teaching: no \skt{tanmātra}s are mentioned,
...
\phantomsection\subsection*{Adhyāya 21}\label{contents_of_ch21}
...
\phantomsection\subsection*{Adhyāya 22}\label{contents_of_ch22}
...
\phantomsection\subsection*{Adhyāya 23}\label{contents_of_ch23}
...
\phantomsection\subsection*{Adhyāya 24}\label{contents_of_ch24}
