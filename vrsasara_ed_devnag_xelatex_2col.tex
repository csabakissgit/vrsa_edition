...
\usepackage[total={11.7cm,17cm},
top=4cm, left=5cm, headsep=1.1cm, footskip=3cm, footnotesep=1cm]{geometry}
...
\input{/home/csaba/indology/dharma_project/vrsa_edition/vrsasara_macros_devnag_xelatex_2col.tex}
