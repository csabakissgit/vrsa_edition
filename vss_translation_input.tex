...
\translation{[Śiva's Egg] is two \textit{parārdha}s long and two \textit{parā\-rdha}s wide, and two \textit{parā\-rdha}s is its [vertical] extension, [measured] in \textit{yojana}s, O great Brahmin.\blankfootnote{2.23 Both \textit{pāda} a and c may be treated as containg two words, the first in
