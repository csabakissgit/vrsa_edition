...
\translation{The ten Tāmasa-Rājasa [beings] are: Balāka-cranes, wild cocks, crows, Bengal kites, painted quails, partridges, vultures, herons, Bakas, and hawks. \blankfootnote{9.22 It would be easy to correct the stem form °\textit{śyena} in \textit{pāda} c to \textit{śyenā} {\rm (}plural{\rm )} but I suspect
...
\translation{The Tāmasa can be characterised as follows: anxious, lazy, deluded, cruel, a thief, pitiless, angry, wicked, and sleepy. \blankfootnote{9.34 In \textit{pāda} a, \textit{piśuno}, the reading of all MSS consulted, could be the right choice
  ...
  a licence often occurring in this text {\rm (}`muta cum liquida'{\rm )}.
 }}
