...
\translation{His staff is self-restraint, his bowl compassion. alms are liberation from transmigration {\rm (}\textit{saṃsāra}{\rm )}. The Tryāyuṣa is the one beyond the two syllables. [The three lines are] prepared with the ashes of knowledge. \blankfootnote{11.28 The Tryāyuṣa is a Vedic mantra, see, e.g., \textit{Ṛgveda-khila} 5.3.6:
  \textit{tryāyuṣam jamadagneḥ kaśyapasya tryāyuṣam |
  agastyasya tryāyuṣam yad devānām tryāyuṣam tan no astu tryāyuṣam} |;
...
\translation{[This is] the second life-stage, as Lord Śiva taught it, O Devī, to me. It, the destruction of birth and death, is [now] also taught to you. \blankfootnote{11.30 One may consider correcting \textit{mamā}° to \textit{mayā}° {\rm (}`it has been taught by \textit{me}'{\rm )},
  but \textit{mama} may be original.
 }}
