...
\newcommand{\vers}{\leftskip2em}
\newcommand{\dnvers}{\leftskip2em}

\newcommand{\sloka}{\vers}

\newcommand{\nemsloka}{\leftskip2em} % for "Saarduulavikrii.dita etc. stanzas: pada a
\newcommand{\nemslokab}{\leftskip4em} % pada b
\newcommand{\nemslokac}{\leftskip2em} % pada c
\newcommand{\nemslokad}{\leftskip4em} % pada d
...
\newcommand{\mssNaNbNc}{{\englishfont N}}
...
\newcommand{\alfejezet}[1]{\begin{center}
        {\textbf{{{\textbf{\large[ }}{\devanagarifont\large#1}{\textbf{\englishfont\large]}}}}}\dontdisplaylinenum
...
{{{\englishfont\textbf{[ }}{\devanagarifont\small#1}{\englishfont\textbf{]}}}}\dontdisplaylinenum
...
{{{\englishfont\textbf{[ }}{\devanagarifont\footnotesize#1}{\englishfont\textbf{]}}}}\dontdisplaylinenum
\addcontentsline{toc}{subsubsection}{#1}
\end{center}
