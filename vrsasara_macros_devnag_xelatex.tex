...
\newcommand{\mssCaCbCc}{{\englishfont C$^{\scriptscriptstyle\Sigma}$\hspace{.1pt}}}
...
\newcommand{\il}{\englishfont{×}} % note that I use × for lost in the base file! this here is an anceps
