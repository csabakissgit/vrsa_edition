\phantomsection\section{Witnesses}
...
\noindent
In the pre-modern era, the \VSS\ has been transmitted exclusively in\linebreak
multiple-text manuscripts that were produced in Nepal. Even when a
...
manuscript.%
	...
	\textit{V{\dharmar}ṣasārasa{\dharmanusvara}graha}, but as De Simini has already
...
Nepālākṣara/Newari), one or two superscript letters for the current location where
the manuscript is deposited (e.g.~`C' for Cambridge, `Ko' for Kolkata), 
...
%\phantomsection\section{How to describe a MS?}\label{how-to-describe-a-ms}
...
\medskip
\label{mss_descr}
\phantomsection\subsection{Cambridge manuscripts}
...
CUDL online catalogue.\footnote{\url{https://cudl.lib.cam.ac.uk/view/MS-ADD-01694-00001/382}}
...
See a detailed description of this manuscript in the CUDL online catalogue.\footnote{\url{https://cudl.lib.cam.ac.uk/view/MS-ADD-01645/404}}
...
ended on \fol236v, with pāda b of verse 7.122,%
 		\footnote{Image no.\thinspace180, 
                  \SivaUp\ 7.122: \skt{yauvanasthā g{\dharmar}hasthāś ca}
                  {[}\skt{prāsā}{]}\skt{dasthāś ca ye n{\dharmar}pāḥ}.}
...
rest of the manuscript, but the hand changes back in the next folio.\label{msCcfirstfolio}%
	...
	beginning of the \skt{V{\dharmar}ṣasārasa{\dharmanusvara}graha}.' A hardly readable
	note in pencil to the same effect is visible at the
    top of the first folio side (\fol267r, `mode\ldots\ldots 
    supply beg of V{\dharmar}ṣasāra-sa{\dharmanusvara}gr.'). I am not sure how `modern'
...
resumes on \fol273r with verse 3.30b ({[}\skt{ahi{\dharmanusvara}sā
pa}{]}\skt{rama{\dharmanusvara}} \skt{sukham}). Folio 291 is missing (verses
...
concluding colophon \skt{v{\dharmar}ṣasārasaṅgraha samāpta iti}.
...
\medskip
\phantomsection\subsection{Kathmandu palm-leaf manuscripts}
\msdescr{(N)\msNa}{nk82}
NGMPP A 1082/3, NAK 3/393. This MS has been fully 
collated for chapters 1--12 of the critical edition in this volume. 
See a brief description of this MS in
the NGMCP online catalogue.%
        \footnote{\url{https://catalogue.ngmcp.uni-hamburg.de/receive/aaingmcp\_ngmcpdocument\_00098499}}
...
It is dated to Nepāla Samvat 189 (1068--69 \CE).%
  ...
  tithau t{\dharmar}tīye}, translated by \mycitep{DeSiminiMSSFromNepal2016}{252 n.\thinspace 49} as:
...
See a brief description of this MS in
the NGMCP online catalogue.\footnote{\url{https://catalogue.ngmcp.uni-hamburg.de/receive/aaingmcp\_ngmcpdocument\_00085264}}
...
up to 1.60 (\skt{vi{\dharmanusvara}śakoṭiṣu gulmeṣu ūrdhva°}).
...
\skt{Umāmaheśvarasa{\dharmanusvara}vāda}, ending in a colophon for its chapter
...
The second line just above the string hole on the left reads \skt{\ldots{} vīrud vanaspatīnā{\dharmanusvara} ca
...
in the NGMCP online catalogue.%
                \footnote{\url{https://catalogue.ngmcp.uni-hamburg.de/receive/aaingmcp\_ngmcpdocument\_00062373}}
...
catalogue.%
        \footnote{\url{http://catalogue-old.ngmcp.uni-hamburg.de/mediawiki/index.php/A\_3-3\_Śivadharma}}
According to this catalogue, the dimensions of the manuscript are
...
%Palm-leaf, dated to NS 516 (1395--96 CE), 253 folios. Contents: Śivadharmaśāstra (fols.~1v--43r); Śivadharmottara (fols.~4v--95r); Śivadharmasa{\dharmanusvara}graha (fols.~96v--139v); Umāmaheśvarasa{\dharmanusvara}vāda (fols.~140v-- 171r); Śivopaniṣad (fols.~172v--189r); Uttarottaramahāsa{\dharmanusvara}vāda (fols.~190v-- 211v); V{\dharmar}ṣasārasa{\dharmanusvara}graha(fols.~212v--257v). For a description of this manuscript, also see the record in the NGMCP online catalogue: \textless{}
        \footnote{\url{http://catalogue.ngmcp.uni-hamburg.de/wiki/A\_11- 3\_Śivadharmottara}}%
...
%Contents: Śivadharmaśāstra (fols.~1v--57r); Śivadharmottara (fols.57v--134v); Śivadharmasa{\dharmanusvara}graha (fols.~135r--215v); Umāmaheśvarasa{\dharmanusvara}vāda (fols.~216v--255r); Śivopaniṣad (fols. 256v--278r); Umottara°/ Uttarottaramahāsa{\dharmanusvara}vāda (fols. 279v--299v¤); V{\dharmar}ṣasārasa{\dharmanusvara}graha (?¤--?¤); (?--?¤).

\medskip
\phantomsection\subsection{Paris manuscript}

\msdescr{(N)\msParis}{np57}
This is a multiple-text palm-leaf manuscript written in 
Nepā\-lā\-kṣara script and preserved in the 
...
%Folio 215v ends with \skt{kautūhalam atī} in 3.14a and the next available folio starts with \skt{tyam iṣṭagatiḥ prokta{\dharmanusvara}} in 4.8a. This means that verses 3.14--42 and 4.1--7 of the VSS, altogether 36 verses are missing. This is indeed approximately the number of verses that two folio sides contain.
...
\medskip
\phantomsection\subsection{Munich manuscript}
...
is dated (\fol50r line 5): \skt{|| iti v{\dharmar}ṣasārasaṅgrahe caturvi{\dharmanusvara}śatimo dhyāyaḥ samāptaḥ | samvat} 192 \skt{māghak{\dharmar}ṣṇadivāpañcamyām || postakalikhitam iti ||.} The year 192 in Nepāla Samvat converts to
...
%The \VSS\ starts in 411.jpg `cover' {[}411.jpg{]}: ||w||v{\dharmar}ṣasārasa{\dharmanusvara}graha 50 patra ||w|| Text starts in 412.jpeg, f.1r Ends on image 455.jpeg
% Kengo writes: ``411.jpg forms a cover that says v{\dharmar}ṣasārasaṅgraha but it is actually 50 verso'' samvat 282? {[}that would be 1161 CE, or is it 292? = 1171 CE{]} No, maybe 192! see Kengo's notes! = 1070 CE
...
\medskip
\phantomsection\subsection{Kolkata manuscripts}
...
if anything, added considerable noise and clutter to the apparatus.%
        \footnote{Another random sample to show the low quality of this source
                  ...
                  the edition):
                  \skt{vigatarāga{\dharmanusvara} tu dhanuḥ k{\dharmar}tvā prāṇāyāmaguṇair{ }yutam} |
                  \skt{dhāraṇāsaratīkṣṇena m{\dharmar}ga{\dharmanusvara} ḍhatvā manendriya{\dharmanusvara}} ||
                  \skt{maitrīkhaḍgam atīkṣṇena sa{\dharmanusvara}sārāni{\dharmanusvara} k{\dharmar}ttayeta} |
       ...
       % \skt{saivasaṅkhyā purāṇañ ca smārtabhāratasa{\dharmanusvara}hitā} ||8.1||
       % \skt{saivatatva{\dharmanusvara} vicintata saivāpāsupatadvaye} |
       % \skt{atra vistarata prokta tatvasārasamucaye} ||8.2||
       % \skt{sa{\dharmanusvara}khyātatva{\dharmanusvara} tu sa{\dharmanusvara}khyeṣu bodhavya tatvacintakaiḥ} |
       ...
       % \skt{smārta varṇṇasamācāra  dharmāṇyāyapravarttaka{\dharmanusvara}} |
       % \skt{śiṣṭācāro vikalpena grāhya tatva asahitaḥ} ||8.5||
       % \skt{itihāsam adhīyānaḥ sarvajñaḥ sa naro bhavet} |
       % \skt{dharmārthakāmamokṣeṣu sa{\dharmanusvara}śayas tena chidyate} || 8:6||
       % \skt{pa{\dharmanusvara}coprasthavinigraha s{\dharmar}ṇuyāva{\dharmanusvara}hito dvija} |
       % \skt{striyo vā garhitaḥ svargaḥ svaya{\dharmanusvara}muktiś ca kīrtyate} |
       % \skt{svapnopaghāta{\dharmanusvara} viprendra divāsvapna{\dharmanusvara} ca pañcamaḥ} ||8:7||
...
MS G 4076 in the collection of The Asiatic Society,\linebreak
Kolkata.%
...
I have collated chapters 1--12,
and the readings of this MS seem to be excellent.
...
There are also signs of a correlation between \msKOb\ and \msNb. See, e.g.,
1.15a, 4.28c, 5.15b, 7.5b, 7.13d, 9.41d, 11.6d.
...
\medskip
\phantomsection\subsection{Tübingen manuscript}
...
\medskip
\phantomsection\subsection{Oxford manuscript}

\msdescr{(N)\msBod}{no15}
This palm-leaf manuscript is deposited in the Bodleian\linebreak
Library, in Oxford, 
...
\medskip
\phantomsection\subsection{London manuscript}
...
[\skt{spha}]\skt{ṭikā{\dharmanusvara}}\lk \skt{ram} [= \skt{°kā{\dharmanusvara}baram}]
...
\skt{sphaṭikā{\dharmanusvara}satam eva ca $||$ devayogāsanāsīto}
\end{quote}
...
[\skt{japo yogas tapo}] \skt{dhyāna{\dharmanusvara} svādhyāyaś ca daśa sm{\dharmar}taḥ}
\end{quote}
...
the damaged \skt{dhyāna{\dharmanusvara}} as \skt{dhāna{\dharmanusvara}}, \skt{svādhyā} as \skt{sādhu}:
...
\skt{kare g{\dharmar}hya tapodhanam~|
...
\includegraphics[scale=.25]{images/hitas_msNa.png}
...
\begin{quote}
\includegraphics[scale=.26]{images/hitas01_msL.png}
\includegraphics[scale=.26]{images/hitas02_msL.png}

\skt{kare \lac\ dhatā{\dharmanusvara} tataḥ $||$ sati hitas tatra tenaiva}
\end{quote}
...
%3) Śivadharmasa{\dharmanusvara}graha, % (s. no. 633), fols.~144r--217v;
%4) Umāmaheśvarasa{\dharmanusvara}vāda, % (s. no. 652), fols.~218v-- 263v;
%5) Śivopaniṣad, %(s. no. 636), fols.~264r--297v; 
%6) Uttarottaramahāsa{\dharmanusvara}vāda, % (s. no. 654), fols.~298r--324r;
%7) V{\dharmar}ṣasārasa{\dharmanusvara}graha, % (s. no. 657), fols.~325r--390r;
...
174 folios. Contents: Śivadharmasa{\dharmanusvara}graha (fols.~89r--133v);
Umāmaheśvarasa{\dharmanusvara}vāda (fols.~134r--163v); Śivopaniṣad (fols. 164r--181r);
Uttarottaramahāsa{\dharmanusvara}vāda (fols.~182r--206v); V{\dharmar}ṣasārasa{\dharmanusvara}graha
...
(fols.~42v--92r); Śivadharmasa{\dharmanusvara}graha (fols. 93v--138v);
Umāmaheśvarasa{\dharmanusvara}vāda (fols.~139v-- 170v); Śivopaniṣad (fols.~171v--188r);
Uttarottaramahāsa{\dharmanusvara}vāda (fols.~189v-- 213r); V{\dharmar}ṣasārasa{\dharmanusvara}graha
(fols.~214v--257r).

-- NAK 4--2537 (NGMPP B 219/3). Paper, 339 folios. Contents:
Śivadharmaśāstra (fols.~1v--58r); Śivadharmottara (fols.~59v--123v);
Śivadharmasa{\dharmanusvara}graha (fols.~124v--161v); Umāmaheśvarasa{\dharmanusvara}vāda (fols.
162v--238v); V{\dharmar}ṣasārasa{\dharmanusvara}graha (fols.~239v--338v). GOTIT

-- NAK 4--93 (NGMPP A 1341/6). Paper, 82 folios. Contents:
Śivadharmasa{\dharmanusvara}graha (fols.~91r¤--135v); V{\dharmar}ṣasārasa{\dharmanusvara}graha
(fols.~204r¤--243v). GOTIT

-- NAK 4--1604 (NGMPP A 1365/3). Paper, 90 folios. Contents: Śivopaniṣad
(fols.~166v--184r); Uttarottaramahāsa{\dharmanusvara}vāda (fols.~185v--210r);
V{\dharmar}ṣasārasa{\dharmanusvara}graha (fols.~211v--255r). For a description of this
manuscript, see the record in the NGMCP online catalogue:
\textless{}\ur{http://catalogue.ngmcp.uni-hamburg.de/wiki}
/A\_1365-3(1)\_Śivopaniṣad\textgreater{} ASK*}

\medskip


\phantomsection\subsection{Kathmandu paper manuscripts}
...
\skt{vijñeyā ca manīṣibhiḥ}.%
                 \footnote{The correct \skt{sandhi} would be
		 				\skt{vijñeyāś ca}.}
...
\begin{figure} 
\includegraphics[scale=.3]{images/vipulauvaca_papermsa_12.31.png}\hspace{3.1em}
        (\msPaperA\ \fol219\recto)

\includegraphics[angle=-2, scale=.3]{images/vipulauvaca_msPaperC223v.png}\hspace{2em}
        (\msPaperC\ \fol223\verso)

\includegraphics[angle=1, scale=.2]{images/vipulauvaca_mscc_12.31monochrome.png}\hspace{4.7em}
        (\msCc\ \fol288\verso)
...
My impression of the text of the \VSS\ in\linebreak
