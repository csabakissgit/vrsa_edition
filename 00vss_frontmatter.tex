...
\vskip.3em
        V{\dharmar}ṣasārasa{\dharmanusvara}graha\\ \vspace{.2em}Volume 1}\\
\end{center}
\vfill
\pagebreak
...
\textit{\large 
	V{\dharmar}ṣasārasa{\dharmanusvara}graha: a Nepalese text of the Śivadharma corpus\\
\vskip.5em	
        Volume 1: Anarthayajña's Sacrifice} (\textit{Chapters 1--12}\/)\\
\vskip.8em	
        \textit{A Critical Edition and Annotated Translation}
\vskip.3em	
\vskip1cm
