...
<xsl:template match="/">
<body>
<link rel="stylesheet" href="style_wrap_lefty.css"/>
<!--<link rel="stylesheet" href="style_wrap.css"/>-->
<!--<link rel="stylesheet" href="style_only_app.css"/>-->
<script xmlns="http://www.w3.org/1999/xhtml" src="mybutton.js"></script>
       <xsl:apply-templates/>
<br/><br/><br/><br/>
</body>
</xsl:template>
...
<xsl:template match="TR">
    <p><trs > 
<!--<hr style="width:50%;text-align:left;margin-left:0;color:#e6e6e6"/> -->
"<xsl:apply-templates />"</trs></p>
</xsl:template>    

<xsl:template match="NOTE">
<!--<div class="tooltip-wrap2"> <p title="Click and hold or double tap and hold!">↓</p>
   <div class="tooltip-content2"> 
<p><note><xsl:apply-templates /></note></p>
   </div>
</div>-->
<p><note><xsl:apply-templates /></note></p>
</xsl:template>    
