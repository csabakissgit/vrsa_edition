\newcommand{\mssALL}{{\allowbreak\rm$\Sigma$}}

% original:
%\newcommand{\msCa}{{\rm C$_\textrm{a}$}}
%\newcommand{\msCaacorr}{{\rm C$_\textrm{a}$\kern-.4em$^{ac}$\/}}
%\newcommand{\msCapcorr}{{\rm C$_\textrm{a}$\kern-.5em$^{pc}$\/}}
% Peter Bisschop etc.:
...
% my try:
\newcommand{\msCa}{{\allowbreak\rm C$_{\scriptscriptstyle 94}$}}
\newcommand{\msCaacorr}{{\allowbreak\rm C$^{\scriptscriptstyle ac}_{\scriptscriptstyle 94}$}}
\newcommand{\msCapcorr}{{\allowbreak\rm C$^{\scriptscriptstyle pc}_{\scriptscriptstyle 94}$}}

% original
%\newcommand{\msCb}{{\rm C$_\textrm{b}$}}
%\newcommand{\msCbacorr}{{\rm C$_\textrm{b}$\kern-.4em$^{ac}$\/}}
%\newcommand{\msCbpcorr}{{\rm C\raisebox{-.1em}{$_\textrm{b}$}\kern-.57em$^{pc}$\/}}
...
\newcommand{\msCb}{{\allowbreak\rm C$_{\scriptscriptstyle 45}$}}
\newcommand{\msCbacorr}{{\allowbreak\rm C$^{\scriptscriptstyle ac}_{\scriptscriptstyle 45}$}}
\newcommand{\msCbpcorr}{{\allowbreak\rm C$^{\scriptscriptstyle pc}_{\scriptscriptstyle 45}$}}

%\newcommand{\msCc}{{\rm C$_\textrm{c}$}}
%\newcommand{\msCcacorr}{{\rm C$_\textrm{c}$\kern-.16cm$^{ac}$\/}}
%\newcommand{\msCcpcorr}{{\rm C$_\textrm{c}$\kern-.16cm$^{pc}$\/}}
...
\newcommand{\msCc}{{\allowbreak\rm C$_{\scriptscriptstyle 02}$}}
\newcommand{\msCcacorr}{{\allowbreak\rm C$^{\scriptscriptstyle ac}_{\scriptscriptstyle 02}$}}
\newcommand{\msCcpcorr}{{\allowbreak\rm C$^{\scriptscriptstyle pc}_{\scriptscriptstyle 02}$}}

%\newcommand{\msNa}{{\rm N$_\textrm{a}$}}
%\newcommand{\msNaacorr}{{\rm N$_\textrm{a}$\kern-.10cm$^{ac}$\/}}
%\newcommand{\msNapcorr}{{\rm N$_\textrm{a}$\kern-.13cm$^{pc}$\/}}
...
\newcommand{\msNa}{{\allowbreak\rm K$_{\scriptscriptstyle 82}$}}
\newcommand{\msNaacorr}{{\allowbreak\rm K$^{\scriptscriptstyle ac}_{\scriptscriptstyle 82}$}}
\newcommand{\msNapcorr}{{\allowbreak\rm K$^{\scriptscriptstyle pc}_{\scriptscriptstyle 82}$}}

\newcommand{\msNb}{{\allowbreak\rm K$_{\scriptscriptstyle 10}$}}
\newcommand{\msNbacorr}{{\allowbreak\rm K$^{\scriptscriptstyle ac}_{\scriptscriptstyle 10}$}}
\newcommand{\msNbpcorr}{{\allowbreak\rm K$^{\scriptscriptstyle pc}_{\scriptscriptstyle 10}$}}

\newcommand{\msNc}{{\allowbreak\rm K$_{\scriptscriptstyle 7}$}}
\newcommand{\msNcacorr}{{\allowbreak\rm K$^{\scriptscriptstyle ac}_{\scriptscriptstyle 7}$}}
\newcommand{\msNcpcorr}{{\allowbreak\rm K$^{\scriptscriptstyle pc}_{\scriptscriptstyle 7}$}}

\newcommand{\msNd}{{\allowbreak\rm K$_{\scriptscriptstyle 3}$}}
\newcommand{\msNdacorr}{{\allowbreak\rm K$^{\scriptscriptstyle ac}_{\scriptscriptstyle 03}$}}
\newcommand{\msNdpcorr}{{\allowbreak\rm K$^{\scriptscriptstyle pc}_{\scriptscriptstyle 03}$}}

\newcommand\msBod{{\allowbreak\rm B}}
\newcommand\msBodacorr{{\allowbreak\rm B}$^{\scriptscriptstyle ac}$}
\newcommand\msBodpcorr{{\allowbreak\rm B}$^{\scriptscriptstyle pc}$}

\newcommand\msL{{\rm L}}
\newcommand\msLacorr{{\rm L$^{\scriptscriptstyle ac}$}}
\newcommand\msLpcorr{{\rm L$^{\scriptscriptstyle pc}$}}

\newcommand\msPaperA{\allowbreak{\rm K$_{\scriptscriptstyle 41}$}}
\newcommand\msPaperAacorr{\allowbreak{\rm K$_{\scriptscriptstyle 41}$}}
\newcommand\msPaperApcorr{\allowbreak{\rm K$_{\scriptscriptstyle 41}$}}

\newcommand\msPaperC{\allowbreak{\rm K$^{\scriptscriptstyle (paper)}_{\scriptscriptstyle 07}$}}
\newcommand\msPaperCacorr{\allowbreak{\rm K$^{\scriptscriptstyle ac (paper)}_{\scriptscriptstyle 07}$}}
\newcommand\msPaperCpcorr{\allowbreak{\rm K$^{\scriptscriptstyle pc (paper)}_{\scriptscriptstyle 07}$}}

\newcommand\msP{{\allowbreak\rm P$_{\scriptscriptstyle 57}$}}
\newcommand\msPacorr{{\allowbreak\rm P$_{\scriptscriptstyle 57}^{\scriptscriptstyle ac}$}}
\newcommand\msPpcorr{{\allowbreak\rm P$_{\scriptscriptstyle 57}^{\scriptscriptstyle pc}$}}

\newcommand\msM{{\allowbreak\rm M}}
\newcommand\msMacorr{{\allowbreak\rm M$^{\scriptscriptstyle ac}$}}
\newcommand\msMpcorr{{\allowbreak\rm M$^{\scriptscriptstyle pc}$}}

\newcommand{\msKOa}{{\allowbreak\rm K$^{\scriptscriptstyle {\rm o}}_{\scriptscriptstyle 77}$}}
\newcommand{\msKOaacorr}{{\allowbreak\rm K$^{\scriptscriptstyle {\rm o}ac}_{\scriptscriptstyle 77}$}}
\newcommand{\msKOapcorr}{{\allowbreak\rm K$^{\scriptscriptstyle {\rm o}pc}_{\scriptscriptstyle 77}$}}

%\newcommand{\Ed}{{\rm Ed$_\textrm{N}$}}
%\newcommand{\Ed}{{\rm E$^{\scriptscriptstyle N}$}}
\newcommand{\Ed}{{\allowbreak\rm E}}




\newcommand{\msCaNa}{{\rm C$_\textrm{a}$N$_\textrm{a}$}}
\newcommand{\msCbNa}{{\rm C$_\textrm{b}$N$_\textrm{a}$}}
\newcommand{\msCcNa}{{\rm C$_\textrm{c}$N$_\textrm{a}$}}
\newcommand{\msCabNa}{{\rm C$_\textrm{a}$C$_\textrm{b}$N$_\textrm{a}$}}
\newcommand{\msCbcNa}{{\rm C$_\textrm{b}$C$_\textrm{c}$N$_\textrm{a}$}}
\newcommand{\msCabcNa}{{\rm C$_\textrm{a}$C$_\textrm{b}$C$_\textrm{c}$N$_\textrm{a}$}}
\newcommand{\msCab}{{\rm C$_\textrm{a}$C$_\textrm{b}$}}
\newcommand{\msCac}{{\rm C$_\textrm{a}$C$_\textrm{c}$}}
\newcommand{\msCbc}{{\rm C$_\textrm{b}$C$_\textrm{c}$}}
\newcommand{\msCabc}{{\rm C$_\textrm{a}$C$_\textrm{b}$$_\textrm{c}$}}




\newcommand{\mssCaCbCc}{{\rm C$_{\scriptscriptstyle\Sigma}$}}
%\newcommand{\mssCaCbCc}{{\rm C\kern-.4em\raise.1em\hbox{C}\kern-.4em\raise.2em\hbox{C}}}
%\newcommand{\mssNaNbNc}{{\rm N$^{\scriptscriptstyle\Sigma}$}}
\newcommand{\mssNaNbNc}{{\rm K\kern-.4em\raise.1em\hbox{K}\kern-.4em\raise.2em\hbox{K}}}
