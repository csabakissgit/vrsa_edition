\newcommand{\Kiss}{{\rm\textsc{Kiss}}}%\index{Kiss, Csaba}}
\newcommand{\Goodall}{{\rm\textsc{Good\-all}}}%\index{Goodall, Dominic}}
\newcommand{\Sanderson}{{\rm \textsc{Sand\-erson}}}%\index{Sanderson, Alexis}}
\newcommand{\Torzsok}{{\rm\textsc{T\"or\-zs\"ok}}}%\index{Törzsök, Judit}}
\newcommand{\Szanto}{{\rm\textsc{Szántó}}}
\newcommand{\Haru}{\textsc{Isa{a}cson}}
\newcommand{\Nirajan}{{\rm \textsc{Kafle}}}
\newcommand{\Kafle}{{\rm \textsc{Kafle}}}
\newcommand{\Yokochi}{{\rm \textsc{Yokochi}}}
...
%%% Apparatus signs
\newcommand{\corrKiss}{{\rm\corr}}
\newcommand{\emeKiss}{{\rm\eme}}
\newcommand{\conjKiss}{{\rm\conj}}
\newcommand{\corrHaru}{\corr~\Haru}
\newcommand{\emeHaru}{{\rm\eme~\Haru}}
...
\newcommand{\corrSzanto}{\rm\corr~\textsc{Sz\'ant\'o}}
\newcommand{\emeSzanto}{\rm\eme~\textsc{Sz\'ant\'o}}
\newcommand{\conjSzanto}{\rm\conj~\textsc{Sz\'ant\'o}}
\newcommand{\corrTorzsok}{{\rm\corr~\Torzsok}}
\newcommand{\emeTorzsok}{{\rm\eme~\Torzsok}}
\newcommand{\conjTorzsok}{{\rm\conj~\Torzsok}}
\newcommand{\corrHatley}{\corr~\Hatley}
\newcommand{\emeHatley}{\eme~\Hatley}
\newcommand{\conjHatley}{\conj~\Hatley}
\newcommand{\corrGoodall}{{\rm\corr~\Goodall}}
\newcommand{\emeGoodall}{{\rm\eme~\Goodall}}
\newcommand{\conjGoodall}{{\rm\conj~\Goodall}}
\newcommand{\corrKafle}{{\rm\corr~\Kafle}}
\newcommand{\emeKafle}{{\rm\eme~\Kafle}}
\newcommand{\conjKafle}{{\rm\conj~\Kafle}}
