...
\usepackage[textwidth=11cm, paperwidth=21cm, paperheight=29.7cm, textheight=18cm, includehead, headsep=1.1cm, footnotesep=.8cm, xetex, footskip=1cm, left=5.2cm]{geometry}
...
\renewcommand{\nemslokac}{\leftskip 1em} % pada c
\renewcommand{\nemslokad}{\leftskip 3em} % pada d
\renewcommand{\nemslokae}{\leftskip 1em} % pada e
\renewcommand{\nemslokaf}{\leftskip 3em} % pada f
\renewcommand{\dnnemsloka}{\leftskip 1em} % for "Saarduulavikrii.dita etc. stanzas: pada a
\renewcommand{\dnnemslokab}{\leftskip 3em} % pada b
\renewcommand{\dnnemslokac}{\leftskip 1em} % pada c
\renewcommand{\dnnemslokad}{\leftskip 3em} % pada d
\renewcommand{\dnnemslokae}{\leftskip 1em} % pada e
...
%\newcommand{\lem}{{\englishfont~\textbf{]}} }
...
\newcommand{\lk}{{\englishfont{\kern.05em\englishfont\textendash}\kern-.45em\shortsyllable\kern.05em}}
...
% EXTERNAL files
\input{vrsasara_vol2_ed_macros_sigla.tex}
\input{vrsasara_vol2_ed_macros_ledmac.tex}
\input{vrsasara_vol2_ed_macros_authors.tex}
