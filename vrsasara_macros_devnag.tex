...
\newcommand{\msNc}{{\rm K$_{\scriptscriptstyle 07}$}\allowbreak}  
\newcommand{\msNcacorr}{{\rm K$^{\scriptscriptstyle ac}_{\scriptscriptstyle 07}$}\allowbreak}
\newcommand{\msNcpcorr}{{\rm K$^{\scriptscriptstyle pc}_{\scriptscriptstyle 07}$}\allowbreak}

\newcommand{\msNd}{{\rm K$_{\scriptscriptstyle 03}$}\allowbreak}  
...
\tolerance=999\normal@pars
  \hsize .47\hsize
\rightskip=0pt\leftskip=1pt
\parindent=10pt \parfillskip=0pt plus 1fil\textit{#3}\penalty-10}
%%%% lemma nelkul%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\footparagraph{C}
\footparagraph{D}
%\foottwocol{D} % if you want 2-col apparatus
\footparagraph{E}

% register separators
%\usepackage{bbding} % for the lohere symbol
%\renewcommand{\normalfootnoterule}{\begin{center}{\tiny\CrossClowerTips}\end{center}}
%\newcommand{\paranormalfootnoterule}{\begin{center}{\rule{3em}{.1pt}}\end{center}\vskip-.1em}

\let\Dfootnoterule=\normalfootnoterule
%\let\Cfootnoterule=\paranormalfootnoterule
\let\Cfootnoterule=\normalfootnoterule
