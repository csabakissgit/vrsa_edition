...
\newcommand{\mssCaCbCc}{{\englishfont C}}
...
\normal@pars
\parindent=-10pt\rightskip=0pt\leftskip=10pt
\tolerance=9999
  \hsize .46\hsize
  %\raggedright
  %\leavevmode 
...
\footparagraph{E}
\foottwocol{C} % if you want 2-col apparatus STEP 1
...
% TWO COLUMN, comment out if no two-column is needed STEP 2:
\let\Cfootfmt\lemmaesszamnelkultwocolfmt
